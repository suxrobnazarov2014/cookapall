...
type StoreValue = {
  ...
  addCustomRecipe: (
    recipe: Partial<CustomRecipe> & Pick<CustomRecipe, "title" | "description" | "image" | "cuisine" | "section" | "ingredients" | "steps" | "price" | "minutes">
  ) => CustomRecipe;
...
export function StoreProvider({ children }: { children: ReactNode }) {
  ...
  const addCustomRecipe: StoreValue["addCustomRecipe"] = useCallback(
    (recipe) => {
      const newRecipe: CustomRecipe = {
        ...
        authorEmail: email ?? (user?.email || "anonymous"),
        authorName: user?.username || "Oshpaz",
      };
